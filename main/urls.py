...
urlpatterns = [
    ...
    distill_path('recovery_and_rehabilitation/', views.recovery_and_rehabilitation, name='recovery_and_rehabilitation', distill_func=get_index, distill_file='recovery_and_rehabilitation.html'),
    ...
    distill_path('elevate_your_performance/', views.elevate_your_performance, name='elevate_your_performance', distill_func=get_index, distill_file='elevate_your_performance.html'),
]